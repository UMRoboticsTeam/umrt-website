<template>
    <div>
            ...
            <!-- <blockquote class="instagram-media" data-instgrm-permalink="https://www.instagram.com/umroboticsteam?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" data-instgrm-version="12" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:undefinedpx;height:undefinedpx;max-height:100%; width:undefinedpx;">
              <div style="padding:16px;">
                ...
                <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
                  <a href="https://www.instagram.com/umroboticsteam?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==/" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank">Shared post</a> on 
        ...
        <Section theme="primary" title="Links & Joining The Team!" id="join">
          <p>Check out our socials and how to join the team by clicking on our linktree below!</p>
          <a class="btn btn-light btn-xl" href="https://linktr.ee/umrt">LINKTREE</a>
        </Section>
...
<script setup>
  // import '~/assets/styles.css' // removed cause flashing
  ...
  // import bgImgUrl from "@/assets/images/TeamPhoto-1.jpg"
  // const bgImgUrl = "@/assets/images/TeamPhoto-1.jpg"
  // const bgImgUrl = require("@/assets/images/TeamPhoto-1.jpg")
  // const bgImg = import.meta.glob('@/assets/images/TeamPhoto-1.jpg', { eager: true })


  


  // const photosPublic = [bgImg];
  // <img v-for="photo in photosPublic" :src="photo" alt="" />

  
  onMounted(() => {
    const instagramJS = document.createElement('script');
    instagramJS.setAttribute(`src`, `//www.instagram.com/embed.js`);
    // instagramJS.setAttribute('async', 'https://www.instagram.com/embed.js');
    document.head.appendChild(instagramJS);
  })
